...
func _ready():
	...
	$Master_Volume_Slider.value = audio_settings.master_volume_slider_value
	$Music_Volume_Slider.value = audio_settings.music_volume_slider_value
	$Game_Volume_Slider.value = audio_settings.sound_effects_volume_slider_value
	$Master_Volume_Mute_Toggle.button_pressed = audio_settings.master_volume_mute_toggle
	$Music_Volume_Mute_Toggle.button_pressed = audio_settings.music_volume_mute_toggle
	$Game_Volume_Mute_Toggle.button_pressed = audio_settings.sound_effects_volume_mute_toggle
...
func _on_master_volume_slider_value_changed(value):
	audio_settings.master_volume_slider_value = $Master_Volume_Slider.value
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("Master"), -80 + audio_settings.master_volume_slider_value)
	
func _on_music_volume_slider_value_changed(value):
	audio_settings.music_volume_slider_value = $Music_Volume_Slider.value
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("Music"), -80 + audio_settings.music_volume_slider_value)

func _on_game_volume_slider_value_changed(value):
	audio_settings.sound_effects_volume_slider_value = $Game_Volume_Slider.value
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("Sound Effects"), -80 + audio_settings.sound_effects_volume_slider_value)
